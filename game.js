// ─── HARD-CODED FIREBASE CONFIG (you will never see config screen again) ───
window.FIREBASE_CONFIG = {
  apiKey: "AIzaSyDtBEH5k1b-Q2E3zXTDgEC5BuqPU0117tA",
  projectId: "team-poker-8b2f0",
  databaseURL: "https://team-poker-8b2f0-default-rtdb.asia-southeast1.firebasedatabase.app"
};
...
function loadConfig() {
  return window.FIREBASE_CONFIG;   // always use hardcoded config
}
function saveConfig() {} // no longer used
...
function setupConfigScreen() {} // disabled forever
...
// (Lobby, Deck, Hand evaluation, seatPosition, buildGameScreen, scaleGameScreen, etc. — all the rest is identical to the working version)
